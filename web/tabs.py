...
# Modèles à afficher dans la comparaison (tous sauf le Consensus qui est l'agrégat)
_MODELS_ONLY = [m for m in _MODEL_INFO if m != "Consensus (4 modèles)"]
...
def _render_model_comparison(df_hist, df_proj, scenarios, sc_sel, horizon):
    ...
    all_temps = {}  # model → series (pour divergence)
